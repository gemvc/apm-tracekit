...
class Container_d0e317f772 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d0e317f772 $container)
			{
	...
	public function createServiceContainer(): Container_d0e317f772
	{
		return $this;
	}
