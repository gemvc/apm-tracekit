...
class Container_8d9ac0d2fc extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8d9ac0d2fc $container)
			{
	...
	public function createServiceContainer(): Container_8d9ac0d2fc
	{
		return $this;
	}
