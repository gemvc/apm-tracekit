...
// source: phar://C:\Users\Ali\Desktop\apm-tracekit\vendor\phpstan\phpstan\phpstan.phar/conf/config.level9.neon
...
class Container_5dc3d04ac9 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0120(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar://C:\Users\Ali\Desktop\apm-tracekit\vendor\phpstan\phpstan\phpstan.phar\conf\config.level9.neon',
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5dc3d04ac9 $container)
			{
	...
	public function createServiceContainer(): Container_5dc3d04ac9
	{
		return $this;
	}
