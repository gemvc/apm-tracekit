...
class Container_88e660c63c extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_88e660c63c $container)
			{
	...
	public function createServiceContainer(): Container_88e660c63c
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PSModulePath' => 'C:\Users\Ali\OneDrive\Documents\WindowsPowerShell\Modules;C:\Program Files\WindowsPowerShell\Modules;C:\WINDOWS\system32\WindowsPowerShell\v1.0\Modules;c:\Users\Ali\.cursor\extensions\ms-vscode.powershell-2025.4.0-universal\modules',
				...
				'VSCODE_GIT_IPC_HANDLE' => '\\\.\pipe\vscode-git-67dc440a4d-sock',
				'VSCODE_GIT_IPC_AUTH_TOKEN' => '676c8ef352e21b7fb45c2ff79e319e40c7fdc5df8af938df7486b9c7d9215934',
			],
		];
	}
