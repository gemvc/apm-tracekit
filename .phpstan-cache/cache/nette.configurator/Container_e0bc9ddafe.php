...
class Container_e0bc9ddafe extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e0bc9ddafe $container)
			{
	...
	public function createServiceContainer(): Container_e0bc9ddafe
	{
		return $this;
	}
