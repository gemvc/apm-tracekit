...
class Container_08f3cf31d8 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_08f3cf31d8 $container)
			{
	...
	public function createServiceContainer(): Container_08f3cf31d8
	{
		return $this;
	}
